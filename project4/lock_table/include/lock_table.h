 ...
 * @details If there are no existing lock, it instantly returns a new lock instance.
 * Otherwise, blocks until all previous lock is released and returns.
 * 
 ...
 * @details Releases given lock and wakes up next blocked <code>lock_acquire()</code>.
 * 
