...
/**
 * @brief   Insert input (key, value) record with its size to data file at the right place.
 *
 * @returns 0 if success.
 *          negative value otherwise.
 */
int db_insert(tableid_t table_id, int64_t key, const char* value, uint16_t val_size);

/**
 * @brief   Find the record corresponding the input key.
 * @details If found, ret_val and val_size will be set to matching value and its size.
 *
 * @returns 0 if success.
 *          negative value otherwise.
 */
