 ...
 * APIs such as tree manager which uses direct page access. These functions do
 * not call any other APIs, but modifying only given data.
 */
 ...
 * <code>page->page_header.reserved_footer.footer_1</code> represents current
 * free space amount.
 *
 * @param page          Leaf page.
 * @returns The pointer to the free space amount, which will be more useful than
 * raw value in purpose like modifying.
 */
